<#
.SYNOPSIS
    One-click installer and launcher for Intune Management Extension Health Verifier
...
Write-Host "    Intune Management Extension Health Verifier" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/intune-ime-health-check.ps1"
